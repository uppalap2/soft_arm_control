...
% for horizontal data RSS paper stuff
...
for ii = 1:length(Pb)
    for jj = 1:length(Pr)
        P_O_end = forward_kin_1(Pb(ii),Pr(jj),0,L);
...
save('P2_data_9cm_h.mat','P2_data_9cm')
...
save('P2_data_15cm_h.mat','P2_data_15cm')
...
save('P2_data_20cm_h.mat','P2_data_20cm')